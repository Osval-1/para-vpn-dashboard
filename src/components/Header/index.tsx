...
const Header = () => {
  return (
    <section className="flex h-20 items-center ">
        <section className="pl-5 flex flex-row gap-4 border-r w-[18.5%] h-full items-center">
        <figure>
          <img src={logo} alt="logo" />
        </figure>
        <h1 className="text-2xl text-text-header font-extrabold font-mont">PARA DASH</h1>
      </section>
      <section className="flex flex-row w-4/5 justify-between float-right px-7 items-center h-full border-b">
        ...
        <div className="flex w-3/5 gap-5 justify-end">
          <div className="flex flex-row bg-background-input rounded-3xl w-64 h-10 pl-4 items-center gap-2 ">
            ...
            <p className="text-xs font-light font-inter" style={{ color: "#8BA3CB" }}>
